      ...
      <Grid item>
        <Grid container
          ...
          <Grid item md
            ...
            <Typography variant='subtitle1' className={classes.subtitle}>
              Yksi päättömän arkkitehtuurin käyttämisen merkittävimmistä eduista on,
              että sinulla on joustavuus julkaista sisältöäsi automaattisesti useilla kanavilla samanaikaisesti.
            </Typography>
            <Typography variant='subtitle1'>
              Static WordPressissä on keskitetty sisällönhallintajärjestelmä,
              joten sinun ei tarvitse huolehtia sisällön alustamisesta uudelleen jokaiselle alustalle.
              Sen sijaan sinun täytyy julkaista sisältö vain kerran, ja Headless-arkkitehtuuri hoitaa kaikki jalkatyöt puolestasi.
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container
          ...
          <Grid item md
            ...
            <Typography variant='subtitle1' className={classes.subtitle}>
              Kun käytät Headless-lähestymistapaa, sisällön näyttämiseen ei ole käyttöliittymää, ja järjestelmä koostuu vain tietokannasta
              ja sovellusohjelmointirajapinta puheluista.
            </Typography>
            <Typography variant='subtitle1'>
              Seurauksena on, että tulevat uudelleensuunnittelut ovat entistä monimutkaisempia,
              koska voit suunnitella verkkosivustosi uudelleen kokonaan murto-osassa tavallista aikaa ilman, että itse CMS: ää olisi uusittava.
            </Typography>
            <Typography variant='subtitle1'>
        ...
        <Grid container
          ...
          <Grid item md
            ...
            <Typography variant='subtitle1'>
              Päättömästä lähestymistavasta poistetaan kaikki tarpeettomat asiat,
              lähinnä käyttöliittymät, jotka voivat hidastaa verkkosivustosi toimintaa.
            </Typography>
            <Typography variant='subtitle1'>
              Headless WordPress -sovellukseen jää vain sisältötietokanta ja API-puhelut,
              jolloin WordPress-sivustosi latautuu valon nopeudella, ¬¬ jopa jos julkaiset sisällön staattisella sivustolla.
            </Typography>
          </Grid>
        </Grid>
